...
func TestIsNonRetryableRefreshError(t *testing.T) {
	tests := []struct {
		...
		{name: "account_deactivated", err: errors.New("account_deactivated"), expected: true},
		{name: "openai_reauth_required", err: errors.New("OPENAI_OAUTH_REAUTH_REQUIRED"), expected: true},
