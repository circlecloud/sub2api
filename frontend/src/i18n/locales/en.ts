export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      bulkSetExpiry: 'Set Expiry',
      bulkSetExpiryTitle: 'Set Filtered Expiry',
      bulkDeleteFiltered: 'Delete Filtered',
      bulkRevokeTitle: 'Delete Filtered Subscriptions',
      ...
      batchTargetCount: '{count} subscriptions match the current filters',
      batchTargetHint: 'Batch actions apply to every subscription in the current filtered result set, including records on other pages.',
      bulkSetExpiryHint: 'This will apply the same expiry time to the current filtered result set. Choosing a future time reactivates non-suspended subscriptions; choosing a past time marks non-suspended subscriptions as expired.',
      ...
      assign: 'Assign',
      assigning: 'Assigning...',
      bulkSetExpiryConfirm: 'Apply to all',
      bulkSettingExpiry: 'Applying...',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
      revoke: 'Revoke',
      ...
      bulkSetExpirySuccess: 'Updated expiry time for {count} subscriptions',
      bulkRevokeSuccess: 'Deleted {count} filtered subscriptions',
      ...
      failedToBulkSetExpiry: 'Failed to set unified expiry time',
      failedToBulkRevoke: 'Failed to delete filtered subscriptions',
      ...
      batchFilterRequired: 'Keep at least one filter before running a batch action',
      batchNoResults: 'No filtered subscriptions are available for this batch action',
      bulkSetExpiryDateRequired: 'Please select an expiry time',
      validityDaysRequired: 'Please enter a valid number of days (at least 1)',
      revokeConfirm:
        "Are you sure you want to revoke the subscription for '{user}'? This action cannot be undone.",
      bulkRevokeConfirm:
        'Delete the {count} subscriptions in the current filtered result set? This applies across all pages and cannot be undone.',
      guide: {
    ...
    accounts: {
      ...
      publicAddLinks: {
        title: 'OpenAI Links',
        description: 'Generate dedicated secret links for the OpenAI OAuth add page. Each link can be restricted to an admin-selected set of OpenAI groups, and visitors can only create accounts within those groups.',
        createTitle: 'Create New Link',
        editTitle: 'Edit Link Settings',
        createHint: 'A single link can allow multiple OpenAI groups while the admin preconfigures the default account settings.',
        editHint: 'After saving, newly created accounts from this link will use the latest admin-configured defaults.',
        accountDefaultsTitle: 'Admin Defaults',
        accountDefaultsHint: 'These settings are automatically applied when an external user creates an OpenAI account through this link.',
        nameLabel: 'Link Name',
        namePlaceholder: 'e.g. Ops team / Vendor team / GPT intake',
        allowedGroups: 'Allowed Groups',
        noOpenAIGroups: 'No available OpenAI groups',
        createAction: 'Create Link',
        listTitle: 'Existing Links',
        listHint: 'Copy a link and share it with whoever needs to add OpenAI accounts.',
        empty: 'No public add links have been created yet',
        unnamed: 'Unnamed link',
        groupUnit: 'groups',
        linkLabel: 'Access Link',
        configSummaryTitle: 'Default Account Settings',
        configSummaryEmpty: 'Only group binding is enforced; no extra account defaults are configured.',
        createdAt: 'Created at: {time}',
        rotate: 'Rotate Link',
        loadFailed: 'Failed to load public links',
        createdSuccess: 'Public link created successfully',
        updatedSuccess: 'Public link settings updated',
        createFailed: 'Failed to create public link',
        updateFailed: 'Failed to update public link',
        rotatedSuccess: 'Public link rotated and copied to clipboard',
        rotateFailed: 'Failed to rotate public link',
        deletedSuccess: 'Public link deleted',
        deleteFailed: 'Failed to delete public link',
        deleteConfirm: 'Delete this public add link? The old link will stop working immediately.'
      },
      publicAddPage: {
        title: 'Add OpenAI Account',
        subtitle: 'Use the admin-provided secret link to complete authorization with OAuth, RT, or an imported token file, then apply the admin-configured account defaults automatically.',
        successTitle: 'Account added successfully',
        successDesc: 'The OpenAI account “{name}” has been created.',
        successBatchDesc: 'Successfully created {count} OpenAI accounts.',
        addAnother: 'Add another account',
        groupLabel: 'Admin-assigned groups',
        groupLayoutHint: 'The groups for this link are pre-assigned by the administrator, and newly created accounts will be bound to them automatically.',
        autoNameHint: 'Account names are automatically taken from the OpenAI email. If the upstream response has no email, the system falls back to a default name.',
        fixedGroupCount: 'Auto-bind {count} groups',
        emptyGroups: 'There are no available groups for this link. Please contact the administrator.',
        invalidLink: 'This link is invalid, expired, or no longer has any available permissions.',
        generateUrlFailed: 'Failed to generate authorization URL. Please try again later.',
        missingAuthInfo: 'Please generate the authorization URL first and provide a valid authorization code.',
        groupRequired: 'Please select at least one group.',
        successToast: 'OpenAI account added successfully',
        createFailed: 'Failed to create the OpenAI account. Please check the authorization code and try again.',
        importTitle: 'Import token file',
        importDesc: 'Supports drag-and-drop or selecting multiple JSON / text token files at once. Files are parsed and previewed automatically before you confirm account creation.',
        importChooseFile: 'Choose token file',
        importOptionLabel: 'Import token file',
        importDetectedMode: 'Detected mode:',
        importDetectedEmail: 'Detected email:',
        importAction: 'Import and create account',
        importReadFailed: 'Failed to read token file',
        importFileRequired: 'Please choose a token file first.',
        importCreateFailed: 'Failed to create account from token file.',
        importNoValidFiles: 'There are no valid token files ready to create accounts.',
        dropzoneTitle: 'Drop token files here',
        dropzoneHint: 'You can upload multiple files at once, or click the button to choose them manually.',
        importSummary: 'Imported {total} files: {ready} ready, {invalid} invalid, {created} created.',
        importProgressParsing: 'Parsing files {current}/{total}',
        importProgressCreating: 'Creating accounts {current}/{total}',
        importProgressCompleted: 'Completed {current}/{total}',
        previewTitle: 'Import preview',
        clearImports: 'Clear preview',
        confirmCreate: 'Confirm create {count} accounts',
        oauthPanelHint: 'The right panel supports OAuth, RT, and Mobile RT, so you can keep the group selection, import preview, and authorization flow visible together on wide screens.',
        previewStatusReady: 'Ready',
        previewStatusCreated: 'Created',
        previewStatusFailed: 'Failed',
        previewStatusInvalid: 'Invalid',
        modeRefreshToken: 'Codex RT',
        modeMobileRefreshToken: 'Mobile RT',
        modeCredentials: 'Direct credentials',
        createdAccountName: 'Created account:'
      },
      ...
      groupIncludeSectionLabel: 'Include Groups',
      groupExcludeSectionLabel: 'Exclude Groups',
      groupFilterHintDefault: 'Select one or more include groups to filter accounts.',
      groupFilterContainsHint: 'Contains match: show accounts that belong to any selected include group.',
      groupFilterExactHint: 'Exact match: the account group set must exactly equal the selected include groups.',
      groupFilterExcludeOnlyHint: 'Exclude accounts that belong to any selected exclude group.',
      groupFilterUngroupedHint: 'Show only accounts that are not assigned to any group.',
      groupExcludeHint: 'Exclude accounts that belong to any selected group.',
      groupFilterMetaDefault: 'Disabled',
      groupFilterMetaContains: 'Contains match',
      groupFilterMetaExact: 'Exact match',
      groupFilterMetaExcludeCount: 'Exclude {count}',
      groupFilterModeLabel: 'Match mode',
      groupFilterModeContains: 'Contains',
      groupFilterModeExact: 'Exact',
      groupFilterSelectedSummary: '{first} +{count}',
      lastUsedFilters: {
        all: 'All Last Used',
        used: 'Used',
        unused: 'Unused',
        range: 'Last Used Time'
      },
      oauthType: 'OAuth',
      ...
      refreshUsageWindow: 'Refresh Usage Window',
      refreshUsageWindowConfirm: 'Refresh the usage window for account "{name}"?',
      refreshUsageWindowSuccessSingle: 'Successfully refreshed the usage window for account "{name}"',
      refreshUsageWindowFailedSingle: 'Failed to refresh account usage window',
      ...
      bulkActions: {
        ...
        menu: 'Bulk Actions',
        menuWithCount: 'Bulk Actions ({count})',
        edit: 'Bulk Edit',
        ...
        setPrivacy: 'Set Privacy',
        refreshUsageWindow: 'Refresh Usage Window',
        refreshUsageWindowFilteredAction: 'Refresh Filtered Usage Windows ({count})',
        refreshUsageWindowAllAction: 'Refresh All Usage Windows ({count})',
        selectedScopeLabel: '{count} selected account(s)',
        filteredScopeLabel: '{count} filtered account(s)',
        allScopeLabel: 'all {count} account(s)',
        refreshUsageWindowConfirm: 'Refresh usage windows for {scope}?',
        refreshingAction: 'Refreshing...',
        settingPrivacyAction: 'Setting...',
        settingPrivacyProgress: 'Applying privacy settings: {processed}/{total}',
        refreshingProgress: 'Refreshing tokens: {processed}/{total}',
        preparingRefreshUsageWindow: 'Preparing refresh targets ({count})...',
        preparingRefreshUsageWindowProgress: 'Loading refresh targets: {loaded}/{total} ({batch} per batch)',
        preparingRefreshUsageWindowActionProgress: 'Preparing refresh targets ({loaded}/{total})...',
        refreshingUsageWindowAction: 'Refreshing usage windows...',
        refreshingUsageWindowProgress: 'Refreshing usage windows: {processed}/{total}',
        refreshingUsageWindowProgressAction: 'Refreshing usage windows ({processed}/{total})...',
        progressSuccess: 'Succeeded: {count}',
        progressFailed: 'Failed: {count}',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        setPrivacySuccess: 'Applied privacy settings to {count} account(s)',
        refreshUsageWindowSuccess: 'Successfully refreshed usage windows for {count} account(s)',
        refreshUsageWindowFailed: 'Failed to refresh usage windows',
        refreshUsageWindowNoMatches: 'No accounts in the current filtered result can be refreshed',
        refreshUsageWindowPrepareFailed: 'Failed to load accounts to refresh',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed'
      },
      bulkTest: {
        action: 'Batch Test',
        title: 'Batch Test Accounts',
        selectionInfo: 'This will test {scope}.',
        selectedScopeLabel: '{count} selected account(s)',
        filteredScopeLabel: '{count} filtered account(s)',
        allScopeLabel: 'all {count} account(s)',
        testFilteredAction: 'Test Filtered Accounts ({count})',
        testAllAction: 'Test All Accounts ({count})',
        preparingAction: 'Preparing test targets ({count})...',
        preparingProgressAction: 'Preparing test targets ({loaded}/{total})...',
        preparingProgressStatus: 'Loading test targets: {loaded}/{total} ({batch} per batch)',
        noMatches: 'No testable accounts in the current filtered result',
        prepareFailed: 'Failed to load accounts to test',
        modelLabel: 'Test Model',
        modelDefaultOption: 'Default Model',
        modelPlaceholder: 'Select a shared test model',
        modelHint: 'Optional. The selected model will be used for all selected accounts; only models shared by all accounts are shown.',
        modelLoadingHint: 'Loading models shared by the selected accounts…',
        modelLoadFailedHint: 'Failed to load shared models. Each account will use its default test model.',
        modelUnavailableHint: 'No shared model was found. Each account will use its default test model.',
        promptLabel: 'Custom Prompt',
        promptPlaceholder: 'Clear to use the system default test prompt',
        promptHint: 'Pre-filled with “只回复OK”. Clear it to use the system default test prompt.',
        concurrencyLabel: 'Test Concurrency',
        concurrencyHint: 'Default {default}, range 1-{max}.',
        promptEffectHint: 'The custom prompt mainly applies to platforms that support prompt-based tests. Other platforms will still use their default test flow.',
        readyStatus: 'Ready to start: {count} account(s)',
        progressStatus: 'Testing: {processed}/{total}',
        completedStatus: 'Completed: {processed}/{total}',
        startAction: 'Start Batch Test',
        testingAction: 'Testing...',
        successCount: 'Succeeded: {count}',
        failedCount: 'Failed: {count}',
        success: 'Batch test completed for {count} account(s)',
        partialSuccess: 'Batch test partially completed: {success} succeeded, {failed} failed',
        errorListTitle: 'Failure details',
        errorItem: 'Account #{id}: {error}',
        emptyResponse: 'Empty test response',
        incompleteResponse: 'Incomplete test result'
      },
      bulkEdit: {
        title: 'Bulk Edit Accounts',
        selectionInfo:
          '{count} account(s) selected. Only checked or filled fields will be updated; others stay unchanged.',
        editFilteredAction: 'Edit Filtered Accounts ({count})',
        editAllAction: 'Edit All Accounts ({count})',
        preparingAction: 'Preparing ({count})...',
        preparingProgressAction: 'Preparing ({loaded}/{total})...',
        preparingSelectedAction: 'Preparing selected accounts ({count})...',
        preparingSelectedProgressAction: 'Preparing selected accounts (scanned {loaded}/{total})...',
        progressStatus: 'Loading filtered accounts: {loaded}/{total} ({batch} per batch)',
        selectedProgressStatus: 'Matching selected accounts: scanned {loaded}/{total} ({batch} per batch)',
        noMatches: 'No editable accounts match the current filters',
        prepareFailed: 'Failed to load filtered accounts',
        prepareSelectedFailed: 'Failed to load selected accounts',
        ...
        updating: 'Updating...',
        updatingProgress: 'Updating ({processed}/{total})...',
    ...
    ops: {
      ...
      rectifierRetries: 'Rectifier retries',
      ...
      openaiWarmPool: {
        ...
        description: 'Inspect Bucket / Global / NetworkError warm-pool state and per-group coverage for OpenAI.',
        loadFailed: 'Failed to load OpenAI warm-pool metrics',
        disabledHint: 'Realtime ops monitoring is disabled, so warm-pool state is unavailable.',
        featureDisabledHint: 'The OpenAI warm pool is currently disabled.',
        readerUnavailableHint: 'The usage reader used for warm probing is not ready yet, so metrics may be incomplete.',
        bootstrappingHint: 'The warm pool is in first-time initialization. The first Bucket / Global fill is still catching up, so current counts may temporarily remain 0.',
        sharedBucket: 'Shared bucket',
        empty: 'There are no active OpenAI buckets right now.',
        accountEmpty: 'No warm-pool account state is available for the selected group.',
        viewReadyList: 'View Global Ready list',
        triggerGlobalRefill: 'Refill Global pool',
        triggerGlobalRefillLoading: 'Refilling...',
        triggerGlobalRefillSuccess: 'Global pool refill triggered',
        triggerGlobalRefillFailed: 'Failed to trigger global pool refill',
        readyListTitle: 'Global Ready accounts',
        readyListEmpty: 'No Global Ready accounts are available in the current scope.',
        readyListLoadFailed: 'Failed to load Global Ready accounts',
        loadMoreReadyList: 'Load more',
        logTitle: 'Recent logs',
        logEmpty: 'There are no warm-pool logs in the selected time range.',
        logLoadFailed: 'Failed to load warm-pool logs',
        bucketTitle: 'Buckets',
        accountTitle: 'Group account states',
        networkErrorTitle: 'NetworkError pool',
        summary: {
          bucketReadyAccounts: 'Bucket',
          globalReadyAccounts: 'Global',
          probingAccounts: 'Probing accounts',
          coolingAccounts: 'Cooling accounts',
          networkErrorAccounts: 'NetworkError',
          takeCount: 'Taken count',
          networkErrorPoolFull: 'NetworkError pool is full',
          trackedAccounts: 'Tracked accounts: {count}',
          lastBucketMaintenance: 'Last bucket maintenance: {time}',
          lastGlobalMaintenance: 'Last global maintenance: {time}'
        },
        table: {
          group: 'Group',
          ready: 'Bucket (Global coverage)',
          takeCount: 'Taken count',
          schedulable: 'Schedulable',
          probing: 'Probing',
          cooling: 'Cooling',
        ...
        accountTable: {
          ...
          state: 'State',
          priority: 'Priority',
          expiresAt: 'Global expires at',
          failUntil: 'Cooling until',
          networkErrorUntil: 'NetworkError until'
        },
        readyListTable: {
          groups: 'Groups',
        ...
        networkError: {
          count: 'Count',
          capacity: 'Capacity',
          oldestEnteredAt: 'Oldest entered at'
        },
        state: {
          ready: 'Ready',
          probing: 'Probing',
      ...
      requestDetails: {
        ...
        table: {
          ...
          duration: 'Duration',
          ttft: 'TTFT',
          diagnosis: 'TTFT Breakdown',
          diagnosisHint: 'Auth / Routing / Prepare / Headers / First Event',
          status: 'Status',
          requestId: 'Request ID',
          actions: 'Actions'
        },
      ...
      settings: {
        ...
        ignoreOpenAIStreamRectifierTimeouts: 'Ignore OpenAI Rectifier Timeout Errors',
        ignoreOpenAIStreamRectifierTimeoutsHint: 'When enabled, exhausted OpenAI rectifier 502 responses are skipped from Ops error logs and SLA. Intermediate rectifier timeouts are never persisted as upstream errors.',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
    ...
    settings: {
      ...
      openaiWarmPool: {
        ...
        sharedHint: 'Global warm readiness is shared at the account level across groups, while Bucket only represents the group-level direct-hit layer.',
        enabled: 'Enable OpenAI Warm Pool',
        enabledHint: 'Prefer OpenAI OAuth accounts from the current group Bucket that recently passed usage probing.',
        bucketTitle: 'Bucket',
        bucketTargetSize: 'Bucket Target Size',
        bucketTargetSizeHint: 'Desired number of Bucket accounts each group tries to keep available.',
        bucketRefillBelow: 'Bucket Refill Threshold',
        bucketRefillBelowHint: 'Trigger Bucket refill when the Bucket count drops below this value.',
        bucketSyncFillMin: 'Bucket Sync Fill Minimum',
        bucketSyncFillMinHint: 'On a cold first request, warm pool returns after the first usable Bucket account is ready, then continues filling in the background up to this value.',
        bucketEntryTtlSeconds: 'Bucket Recheck Interval (s)',
        bucketEntryTtlSecondsHint: 'How long after promotion before an account is rechecked individually. Reaching this timer does not evict the account from Bucket; only a failed recheck does.',
        bucketRefillCooldownSeconds: 'Bucket Refill Cooldown (s)',
        bucketRefillCooldownSecondsHint: 'Minimum interval between repeated refills for the same Bucket.',
        bucketRefillIntervalSeconds: 'Bucket Scan Interval (s)',
        bucketRefillIntervalSecondsHint: 'How often active Buckets are scanned in the background. Set to 0 to disable.',
        globalTitle: 'Global',
        globalTargetSize: 'Global Target Size',
        globalTargetSizeHint: 'Target Global coverage required for each active group. Shared accounts can satisfy multiple active groups at once, so this is not a simple unique-account count.',
        globalRefillBelow: 'Global Refill Threshold',
        globalRefillBelowHint: 'Trigger Global refill when any active group falls below this coverage threshold; it is not based on the total unique Global-ready count.',
        globalEntryTtlSeconds: 'Global TTL (s)',
        globalEntryTtlSecondsHint: 'How long a Global ready result stays valid. If the account no longer belongs to any active group, it will be pruned from Global earlier.',
        globalRefillCooldownSeconds: 'Global Refill Cooldown (s)',
        globalRefillCooldownSecondsHint: 'Minimum interval between repeated Global refills.',
        globalRefillIntervalSeconds: 'Global Scan Interval (s)',
        globalRefillIntervalSecondsHint: 'How often Global maintenance runs in the background. Set to 0 to disable.',
        networkErrorTitle: 'NetworkError',
        networkErrorPoolSize: 'NetworkError Pool Size',
        networkErrorPoolSizeHint: 'Accounts with network-class probe failures enter the NetworkError pool.',
        networkErrorEntryTtlSeconds: 'NetworkError TTL (s)',
        networkErrorEntryTtlSecondsHint: 'How long a network-problem account stays in NetworkError before Global retry can prioritize it again.',
        probeTitle: 'Probe',
        probeMaxCandidates: 'Max Probe Candidates',
        probeMaxCandidatesHint: 'Maximum number of candidate accounts probed in one round.',
        probeConcurrency: 'Probe Concurrency',
        probeConcurrencyHint: 'How many usage probes may run at the same time.',
        probeTimeoutSeconds: 'Probe Timeout (s)',
        probeTimeoutSecondsHint: 'Timeout for a single account usage probe.',
        probeFailureCooldownSeconds: 'Failure Cooldown (s)',
        probeFailureCooldownSecondsHint: 'How long to wait before probing the same non-network failed account again.',
        startupGroups: 'Startup Warm Groups',
        startupGroupsHint: 'Used only for the first warm-up pass after service startup. Select existing OpenAI groups; if none are selected, startup prewarming is skipped.'
      },
      gatewayForwarding: {
        ...
        cchSigningHint: 'Sign the billing header in forwarded requests with a CCH hash. When disabled, the original placeholder is preserved.',
        openaiStreamRectifier: 'OpenAI Stream Rectifier',
        openaiStreamRectifierHint: 'OpenAI-specific rectifier settings have moved to the OpenAI tab.',
      },
      openaiRectifier: {
        title: 'OpenAI Stream Rectifier',
        description: 'Configure independent timeout sequences for the response-header phase and the first-token phase. When exhausted, the current request returns 502.',
        enabled: 'Enable OpenAI Stream Rectifier',
        enabledHint: 'When enabled, the response-header phase and first-token phase advance independently with their own timeout lists.',
        responseHeaderTimeouts: 'Response header timeouts (s)',
        responseHeaderTimeoutsHint: 'Manage the timeout sequence as tags. Type a value and press Enter or Tab, or paste 8,10,12 / multi-line content.',
        responseHeaderPlaceholder: 'Type seconds and press Enter',
        firstTokenTimeouts: 'First token timeouts (s)',
        firstTokenTimeoutsHint: 'Manage the timeout sequence as tags. Type a value and press Enter or Tab, or paste 5,8,10 / multi-line content.',
        firstTokenPlaceholder: 'Type seconds and press Enter',
        validationRequired: ' cannot be empty. Add at least one positive integer second value.',
        validationPositiveInteger: ' must contain only positive integer seconds.'
      },
      webSearchEmulation: {
