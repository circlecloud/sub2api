export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      bulkSetExpiry: '统一到期',
      bulkSetExpiryTitle: '统一设置筛选结果到期时间',
      bulkDeleteFiltered: '删除已筛选',
      bulkRevokeTitle: '删除当前筛选结果',
      ...
      batchTargetCount: '当前筛选结果共 {count} 个订阅',
      batchTargetHint: '批量操作会作用于当前筛选结果中的全部订阅，包含未显示在当前分页中的记录。',
      bulkSetExpiryHint: '将把当前筛选结果中的订阅到期时间统一为该时间。若设为未来时间，未暂停的订阅会恢复为生效；若设为过去时间，未暂停的订阅会统一变为已过期。',
      ...
      assign: '分配',
      assigning: '分配中...',
      bulkSetExpiryConfirm: '统一设置',
      bulkSettingExpiry: '设置中...',
      adjust: '调整',
      adjusting: '调整中...',
      revoke: '撤销',
      resetQuota: '重置配额',
      ...
      bulkSetExpirySuccess: '已统一更新 {count} 个订阅的到期时间',
      bulkRevokeSuccess: '已删除 {count} 个筛选结果中的订阅',
      subscriptionAdjusted: '订阅调整成功',
      subscriptionRevoked: '订阅撤销成功',
      failedToLoad: '加载订阅列表失败',
      failedToAssign: '分配订阅失败',
      failedToBulkSetExpiry: '统一设置到期时间失败',
      failedToBulkRevoke: '删除筛选结果订阅失败',
      ...
      batchFilterRequired: '请至少保留一个筛选条件后再执行批量操作',
      batchNoResults: '当前筛选结果为空，无法执行批量操作',
      bulkSetExpiryDateRequired: '请选择统一到期时间',
      validityDaysRequired: '请输入有效的天数（至少1天）',
      revokeConfirm: "确定要撤销 '{user}' 的订阅吗？此操作无法撤销。",
      bulkRevokeConfirm: '确定要删除当前筛选结果中的 {count} 个订阅吗？此操作会跨所有分页生效，且无法撤销。',
      guide: {
        title: '订阅管理教程',
    ...
    accounts: {
      ...
      publicAddLinks: {
        title: 'OpenAI 链接',
        description: '为 OpenAI OAuth 添加页生成独立密钥链接。每个链接都可以绑定一组管理员指定的 OpenAI 分组，访问者只能在这些分组内创建账号。',
        createTitle: '创建新链接',
        editTitle: '编辑链接配置',
        createHint: '一个链接可以允许多个 OpenAI 分组，并由管理员预设新账号默认配置。',
        editHint: '修改后，后续通过该链接新建的账号将使用最新的管理员配置。',
        accountDefaultsTitle: '管理员默认配置',
        accountDefaultsHint: '这些参数会在外部用户通过该链接创建 OpenAI 账号时自动套用。',
        nameLabel: '链接名称',
        namePlaceholder: '例如：运营组 / 外包组 / GPT 链接',
        allowedGroups: '允许的分组',
        noOpenAIGroups: '暂无可用的 OpenAI 分组',
        createAction: '创建链接',
        listTitle: '已有链接',
        listHint: '复制链接即可分发给需要添加 OpenAI 账号的人员。',
        empty: '还没有创建任何公开添加链接',
        unnamed: '未命名链接',
        groupUnit: '个分组',
        linkLabel: '访问链接',
        configSummaryTitle: '默认账号配置',
        configSummaryEmpty: '仅限制分组，未额外配置账号默认参数。',
        createdAt: '创建时间：{time}',
        rotate: '重置链接',
        loadFailed: '加载公开链接失败',
        createdSuccess: '公开链接创建成功',
        updatedSuccess: '公开链接配置已更新',
        createFailed: '创建公开链接失败',
        updateFailed: '更新公开链接失败',
        rotatedSuccess: '公开链接已重置并复制到剪贴板',
        rotateFailed: '重置公开链接失败',
        deletedSuccess: '公开链接已删除',
        deleteFailed: '删除公开链接失败',
        deleteConfirm: '确定删除这个公开添加链接吗？删除后原链接将立即失效。'
      },
      publicAddPage: {
        title: '添加 OpenAI 账号',
        subtitle: '使用管理员提供的密钥链接，通过 OAuth、RT 或导入 token 文件完成授权，并自动套用管理员预设的账号配置。',
        successTitle: '账号添加成功',
        successDesc: 'OpenAI 账号“{name}”已创建完成。',
        successBatchDesc: '已成功创建 {count} 个 OpenAI 账号。',
        addAnother: '继续添加另一个账号',
        groupLabel: '管理员指定分组',
        groupLayoutHint: '此链接绑定的分组由管理员预先指定，添加账号时会自动绑定到这些分组。',
        autoNameHint: '账号名称会自动使用对应 OpenAI 邮箱；如果上游未返回邮箱，则使用系统默认名称。',
        fixedGroupCount: '固定绑定 {count} 个分组',
        emptyGroups: '当前链接没有可用分组，请联系管理员。',
        invalidLink: '当前链接无效、已失效，或没有可用权限。',
        generateUrlFailed: '生成授权链接失败，请稍后重试。',
        missingAuthInfo: '请先生成授权链接，并填写正确的授权码。',
        groupRequired: '请至少选择一个分组。',
        successToast: 'OpenAI 账号添加成功',
        createFailed: '创建 OpenAI 账号失败，请检查授权码后重试。',
        importTitle: '导入 token 文件',
        importDesc: '支持拖拽上传或一次选择多个 JSON / 文本 token 文件。导入后会先自动识别并预览，再由你确认创建。',
        importChooseFile: '选择 token 文件',
        importOptionLabel: '导入 token 文件',
        importDetectedMode: '识别模式：',
        importDetectedEmail: '识别邮箱：',
        importAction: '导入并创建账号',
        importReadFailed: '读取 token 文件失败',
        importFileRequired: '请先选择一个 token 文件。',
        importCreateFailed: '使用 token 文件创建账号失败。',
        importNoValidFiles: '当前没有可创建的 token 文件。',
        dropzoneTitle: '拖拽 token 文件到这里',
        dropzoneHint: '支持多文件同时上传，也可点击按钮手动选择。',
        importSummary: '共导入 {total} 个文件：待创建 {ready} 个，无效 {invalid} 个，已创建 {created} 个。',
        importProgressParsing: '正在解析文件 {current}/{total}',
        importProgressCreating: '正在创建账号 {current}/{total}',
        importProgressCompleted: '处理完成 {current}/{total}',
        previewTitle: '导入预览',
        clearImports: '清空预览',
        confirmCreate: '确认创建 {count} 个账号',
        oauthPanelHint: '右侧区域支持 OAuth、RT 和 Mobile RT 三种方式；适合在大屏上同时查看分组、导入预览和授权操作。',
        previewStatusReady: '待创建',
        previewStatusCreated: '已创建',
        previewStatusFailed: '创建失败',
        previewStatusInvalid: '无效文件',
        modeRefreshToken: 'Codex RT',
        modeMobileRefreshToken: 'Mobile RT',
        modeCredentials: '直接凭证导入',
        createdAccountName: '创建结果：'
      },
      ...
      groupIncludeSectionLabel: '包含分组',
      groupExcludeSectionLabel: '排除分组',
      groupFilterHintDefault: '可选择一个或多个包含分组进行筛选。',
      groupFilterContainsHint: '模糊匹配：命中任一已选包含分组即可显示。',
      groupFilterExactHint: '精准匹配：账号分组集合必须与所选包含分组完全一致。',
      groupFilterExcludeOnlyHint: '当前仅排除命中任一已选排除分组的账号。',
      groupFilterUngroupedHint: '仅显示未分配到任何分组的账号。',
      groupExcludeHint: '排除命中任一已选分组的账号。',
      groupFilterMetaDefault: '未启用',
      groupFilterMetaContains: '模糊匹配',
      groupFilterMetaExact: '精准匹配',
      groupFilterMetaExcludeCount: '排除 {count} 个',
      groupFilterModeLabel: '匹配模式',
      groupFilterModeContains: '模糊',
      groupFilterModeExact: '精准',
      ...
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      refreshUsageWindow: '刷新用量窗口',
      refreshUsageWindowConfirm: '确定刷新账号“{name}”的用量窗口吗？',
      refreshUsageWindowSuccessSingle: '已成功刷新账号“{name}”的用量窗口',
      refreshUsageWindowFailedSingle: '刷新账号用量窗口失败',
      noAccountsYet: '暂无账号',
      ...
      bulkActions: {
        ...
        setPrivacy: '批量设置隐私',
        refreshUsageWindow: '刷新用量窗口',
        refreshUsageWindowFilteredAction: '刷新筛选结果用量窗口（{count}）',
        refreshUsageWindowAllAction: '刷新全部账号用量窗口（{count}）',
        selectedScopeLabel: '已选中的 {count} 个账号',
        filteredScopeLabel: '筛选结果中的 {count} 个账号',
        allScopeLabel: '全部 {count} 个账号',
        refreshUsageWindowConfirm: '确定刷新{scope}的用量窗口吗？',
        refreshingAction: '刷新中...',
        settingPrivacyAction: '设置中...',
        settingPrivacyProgress: '正在设置隐私：{processed}/{total}',
        refreshingProgress: '正在刷新令牌：{processed}/{total}',
        preparingRefreshUsageWindow: '准备刷新目标（{count}）...',
        preparingRefreshUsageWindowProgress: '正在加载刷新目标：{loaded}/{total}（每批 {batch} 条）',
        preparingRefreshUsageWindowActionProgress: '准备刷新目标（{loaded}/{total}）...',
        refreshingUsageWindowAction: '刷新用量窗口中...',
        refreshingUsageWindowProgress: '正在刷新用量窗口：{processed}/{total}',
        refreshingUsageWindowProgressAction: '刷新用量窗口（{processed}/{total}）...',
        progressSuccess: '成功 {count} 个',
        progressFailed: '失败 {count} 个',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        setPrivacySuccess: '已成功为 {count} 个账号设置隐私',
        refreshUsageWindowSuccess: '已成功刷新 {count} 个账号的用量窗口',
        refreshUsageWindowFailed: '刷新用量窗口失败',
        refreshUsageWindowNoMatches: '当前筛选结果中没有可刷新的账号',
        refreshUsageWindowPrepareFailed: '加载待刷新账号失败',
        partialSuccess: '操作部分完成：{success} 成功，{failed} 失败'
      },
      bulkTest: {
        action: '批量测试',
        title: '批量测试账号',
        selectionInfo: '将测试{scope}。',
        selectedScopeLabel: '已选中的 {count} 个账号',
        filteredScopeLabel: '筛选结果中的 {count} 个账号',
        allScopeLabel: '全部 {count} 个账号',
        testFilteredAction: '测试筛选结果（{count}）',
        testAllAction: '测试全部账号（{count}）',
        preparingAction: '准备测试目标（{count}）...',
        preparingProgressAction: '准备测试目标（{loaded}/{total}）...',
        preparingProgressStatus: '正在加载测试目标：{loaded}/{total}（每批 {batch} 条）',
        noMatches: '当前筛选结果中没有可测试的账号',
        prepareFailed: '加载待测试账号失败',
        modelLabel: '测试模型',
        modelDefaultOption: '默认模型',
        modelPlaceholder: '选择共同测试模型',
        modelHint: '可选。将对所选账号统一使用该模型；仅展示共同可用的模型。',
        modelLoadingHint: '正在加载所选账号共同可用的模型…',
        modelLoadFailedHint: '共同模型加载失败，将使用各账号默认测试模型。',
        modelUnavailableHint: '未找到共同可用模型，将使用各账号默认测试模型。',
        promptLabel: '自定义提示词',
        promptPlaceholder: '清空则使用系统默认测试提示词',
        promptHint: '默认已填入“只回复OK”，清空时使用系统默认测试提示词。',
        concurrencyLabel: '测试并发数',
        concurrencyHint: '默认 {default}，范围 1-{max}。',
        promptEffectHint: '自定义提示词主要对支持提示词测试的平台生效，其他平台仍按默认测试流程执行。',
        readyStatus: '待开始：共 {count} 个账号',
        progressStatus: '正在测试：{processed}/{total}',
        completedStatus: '测试完成：{processed}/{total}',
        startAction: '开始批量测试',
        testingAction: '测试中...',
        successCount: '成功 {count} 个',
        failedCount: '失败 {count} 个',
        success: '批量测试完成，成功 {count} 个账号',
        partialSuccess: '批量测试部分完成：成功 {success} 个，失败 {failed} 个',
        errorListTitle: '失败详情',
        errorItem: '账号 #{id}：{error}',
        emptyResponse: '测试返回为空',
        incompleteResponse: '测试结果不完整'
      },
      bulkEdit: {
        title: '批量编辑账号',
        selectionInfo: '已选择 {count} 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
        editFilteredAction: '编辑筛选结果（{count}）',
        editAllAction: '编辑全部账号（{count}）',
        preparingAction: '准备中（{count}）...',
        preparingProgressAction: '准备中（{loaded}/{total}）...',
        preparingSelectedAction: '准备已选账号（{count}）...',
        preparingSelectedProgressAction: '准备已选账号（已扫描 {loaded}/{total}）...',
        progressStatus: '正在加载筛选结果：{loaded}/{total}（每批 {batch} 条）',
        selectedProgressStatus: '正在匹配已选账号：已扫描 {loaded}/{total}（每批 {batch} 条）',
        noMatches: '当前筛选结果中没有可编辑的账号',
        prepareFailed: '加载筛选结果失败',
        prepareSelectedFailed: '加载已选账号失败',
        baseUrlPlaceholder: 'https://api.anthropic.com 或 https://api.openai.com',
        baseUrlNotice: '仅适用于 API Key 账号，留空则不修改',
        submit: '批量更新',
        updating: '更新中...',
        updatingProgress: '更新中（{processed}/{total}）...',
    ...
    ops: {
      ...
      requestDetails: {
        ...
        table: {
          ...
          ttft: '首 Token 耗时',
          diagnosis: 'TTFT 分段',
          diagnosisHint: '鉴权 / 路由 / 预处理 / 响应头 / 首事件',
          status: '状态码',
          requestId: '请求ID',
          actions: '操作'
        },
      ...
      settings: {
        ...
        ignoreOpenAIStreamRectifierTimeouts: '忽略 OpenAI 整流器超时错误',
        ignoreOpenAIStreamRectifierTimeoutsHint: '启用后，OpenAI 整流器 exhausted 后返回给客户端的 502 不会写入运维错误日志，也不会计入 SLA。中间阶段整流超时本身始终不会进入上游错误。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiStreamRectifier: 'OpenAI 流式整流器',
        openaiStreamRectifierHint: 'OpenAI 专属整流器配置已迁移到“OpenAI 配置”页。',
      },
      openaiRectifier: {
        title: 'OpenAI 流式整流器',
        description: '分别配置响应头阶段与首 Token 阶段的独立整流超时，超时后当前请求直接返回 502。',
        enabled: '启用 OpenAI 流式整流器',
        enabledHint: '开启后，响应头阶段与首 Token 阶段会分别按各自的超时序列独立推进。',
        responseHeaderTimeouts: '响应头整流超时（秒）',
        responseHeaderTimeoutsHint: '以 Tag 形式维护超时序列，输入秒数后按回车或 Tab 添加，也可粘贴 8,10,12 或多行内容。',
        responseHeaderPlaceholder: '输入秒数后按回车添加',
        firstTokenTimeouts: '首 Token 整流超时（秒）',
        firstTokenTimeoutsHint: '以 Tag 形式维护超时序列，输入秒数后按回车或 Tab 添加，也可粘贴 5,8,10 或多行内容。',
        firstTokenPlaceholder: '输入秒数后按回车添加',
        validationRequired: '不能为空，请至少添加一个正整数秒数。',
        validationPositiveInteger: '必须全部为正整数秒数。'
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',
